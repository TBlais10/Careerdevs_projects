//Coded by Taylor Blais, Brett, and Rich
...
function departmentsData() {
    ...
    let departmentInfo = [] //The new array containing the separate objects
    ...
    for (let i = 0; i < departments.length; i++) {
        ...
        for (let j = 0; j < employeeDepartment.length; j++) {
            ...
            if (dept[0] === emplDept[1] && emplDept[3] == "9999-01-01") {
                ...
                for (let k = 0; k < employees.length; k++) {
                    ...
                    if (empl[0] == emplDept[0]) total++

                    if (empl[0] == emplDept[0] && empl[4] === 'M') maleCount++

                    if (empl[0] == emplDept[0] && empl[4] === 'F') femaleCount++
        ...
        let deptData = { id: dept[0], names: dept[1], totalEmployees: total, genders: { male: maleCount, female: femaleCount } }
...
//departmentsData() //coded by Brett


//need to check the salary for end dates.
//also need to go through departments and employee departments for the different department names.
...
employeeData() //Code by Rich

//console.log(departmentInfo)
//console.log(departments)
//console.log(employees)

//Math.PI for the radius